...
public class LoginActivity extends Activity {
	...
	public void attemptLogin() {
		...
		if (cancel) {
			...
			rp.put("LoginForm_username", mEmail);
			rp.put("LoginForm_password", mPassword);
			rp.put("LoginForm_rememberMe", "1");
			
			client.post(Constants.URL_SERVER+"site/LoginAndroid",rp, new JsonHttpResponseHandler(){
				 @Override
				 public void onSuccess(JSONObject jObject){    
					 try {
						boolean result = jObject.getBoolean("authenticated");
						if (result){
				    		Intent intent = new Intent(LoginActivity.this, MainActivity.class);
							startActivity(intent);
				    	}else{
